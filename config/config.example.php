...
return [
    ...
    'mcp_allow_private_urls' => false, // Let upload_image_from_url fetch loopback/private hosts (local testing ONLY)
    'mcp_allowed_tools' => ['list_pages', 'create_page', 'read_page', 'delete_page', 'duplicate_page', 'publish_page', 'discard_draft', 'list_blocks', 'read_block', 'update_block', 'insert_block', 'search_blocks', 'find_and_replace_block_content', 'search_in_page', 'get_page_region', 'update_page_region', 'list_backups', 'restore_backup', 'list_global_backups', 'restore_global_backup', 'list_posts', 'create_post', 'read_post', 'update_post', 'publish_post', 'unpublish_post', 'delete_post', 'schedule_post', 'list_authors', 'get_author', 'manage_author', 'list_files', 'read_file', 'search_in_file', 'update_file_region', 'list_templates', 'read_template', 'update_template', 'upload_file', 'upload_image', 'upload_image_from_url', 'list_media', 'update_media', 'delete_media', 'generate_image', 'get_page_meta', 'update_page_meta', 'get_ai_txt', 'update_ai_txt', 'get_usage_tips'],   // Allowed MCP tools (tools added later are enabled unless listed in mcp_disabled_tools)
    'mcp_disabled_tools' => [],        // Tools the admin grid switched off (deny-list, survives engine updates)
];
